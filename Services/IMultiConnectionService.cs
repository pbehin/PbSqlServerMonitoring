...
public interface IMultiConnectionService
{
    ...
    /// <param name="userId">User ID that owns this connection</param>
    /// <param name="userMaxConnections">User's max connection limit (null uses default from config)</param>
    ...
    /// </summary>
    Task<int> CleanupStaleReauthConnectionsAsync(
